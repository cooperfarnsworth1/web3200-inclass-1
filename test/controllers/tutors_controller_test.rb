...
class TutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor" do
    assert_difference("Tutor.count") do
      post tutors_url, params: { tutor: { bio: @tutor.bio, email: @tutor.email, name: @tutor.name } }
    end
  ...
  test "should update tutor" do
    patch tutor_url(@tutor), params: { tutor: { bio: @tutor.bio, email: @tutor.email, name: @tutor.name } }
